...
class IdleService
{
    ...
    public function calculateOfflineProgress(User $user): array
    {
        ...
        DB::transaction(function () use ($user, $heroes, $totalXp, $totalGold, $materialDrops, $zone, $victories, $defeats, $totalCombats, $now, $exploration, $events, $repGained, $combatsToSimulate) {
            $user->gold += $totalGold;
