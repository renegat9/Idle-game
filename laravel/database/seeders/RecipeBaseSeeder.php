...
/**
 * Recettes toujours disponibles dès le début du jeu (non découvrables).
 * Sources : ECONOMY.md §8.1 (consommables) + base équipement.
 */
class RecipeBaseSeeder extends Seeder
{
