...
class GameSettingsSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['LOOT_AI_GENERATION_MIN_RARITY', 3, 'Rareté minimum pour déclencher Gemini (3 = Rare, 4 = Épique)'],
            ['LOOT_IMAGE_POOL_SIZE', 3, 'Nombre max d\'images générées par combinaison slot+rareté (pool réutilisé ensuite)'],
